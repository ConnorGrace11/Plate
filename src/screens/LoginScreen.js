...
import { Pressable, ScrollView, StyleSheet, TextInput, Button, Text, Image, View, SafeAreaView, Alert, } from 'react-native';
...
const EmailForm = ({ buttonText, children, onAuthentication, navigation}) => {
  ...
  async function submit (e) {
    ...
    axios.post("http://192.168.0.8:5000/api/auth/login", { //192.168.0.8
            email: email,
            password: password
        })
        .then((response) => {
